          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row items-center">
              ...
              <div className="ml-8 flex items-center">
                ...
                <a className="text-gray-600 px-4" href="https://www.linkedin.com/in/khomotso-gojela-149995216/" target='-blank'><FaLinkedin size={24}/></a>
                <a className="text-gray-600 px-4" href="https://github.com/khomotso-gojela" target='-blank'><FaGithub size={24}/></a>
              </div>
